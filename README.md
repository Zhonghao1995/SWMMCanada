...
|---|---|---|
| **Real network** | uses the city's published storm pipes (real inverts, diameters, manholes, and outfalls) | **36 cities** that publish a storm network: Victoria, Ottawa, Toronto, Calgary, Surrey, London, Kitchener, Waterloo, Kelowna, Regina, Vancouver, Coquitlam, Burnaby, New Westminster, White Rock, North Vancouver District, Nanaimo, Penticton, Esquimalt, Kamloops, Langley Township, Delta, Chilliwack, Port Coquitlam, Strathcona County, Barrie, Abbotsford, Saskatoon, Kingston, Peterborough, Sarnia, Windsor, Whitby, Greater Sudbury, Moncton, and Reykjavík (IS) — the first international city, on Iceland's national *fitjuskrá* schema |
...
backend/swmmcanada/      # Python pipeline: open data -> SWMM model
  ...
  sources/     live data adapters (climate, DEM incl. 1 m LiDAR auto-select, ECCC IDF design storms, land cover, soil, OSM streets)
    cities/    base.py (shared assembler) + 36 real-network adapters (victoria · ottawa · toronto · calgary · surrey · london · kitchener · waterloo · kelowna · regina · vancouver · coquitlam · burnaby · newwestminster · whiterock · northvandistrict · nanaimo · penticton · esquimalt · kamloops · langley · delta · chilliwack · portcoquitlam · strathcona · barrie · abbotsford · saskatoon · kingston · peterborough · sarnia · windsor · whitby · sudbury · moncton · reykjavik)
  ...
  pipeline.py  build_from_aoi · build_from_<city> (36 real-network cities)
...
- **[Case study: Graham Creek](results/graham-creek/README.md)**: the uncalibrated model vs a real WSC flow gauge over a 22 km² Ottawa basin — all 12 rainfall events reproduced on the correct days, volume bias −22%, with the remaining gaps explained honestly.
...
> Zhang, Z. (2026). *SWMMCanada: ready-to-run EPA SWMM models anywhere in Canada from open data* (Version 0.5.0) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.21058544
