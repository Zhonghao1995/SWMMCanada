...
backend/swmmcanada/      # Python pipeline: open data -> SWMM model
  ...
  sources/     live data adapters (climate, DEM incl. 1 m LiDAR auto-select, ECCC IDF design storms, land cover, soil, OSM streets)
    cities/    base.py (shared assembler) + 33 real-network adapters (victoria · ottawa · toronto · calgary · surrey · london · kitchener · kelowna · regina · vancouver · coquitlam · burnaby · newwestminster · whiterock · nanaimo · penticton · esquimalt · kamloops · langley · delta · chilliwack · portcoquitlam · strathcona · barrie · abbotsford · saskatoon · kingston · peterborough · sarnia · whitby · sudbury · moncton · reykjavik)
  ...
  pipeline.py  build_from_aoi · build_from_<city> (33 real-network cities)
